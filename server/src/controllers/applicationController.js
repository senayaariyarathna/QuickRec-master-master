...
export const addBasicDetails = async (req, res) => {
  ...
  try {
    ...
    const basicDetails = await ApplicationDAO.createBasicDetails({
      userId: userId,
      // applicationId: application.ApplicationId, //pinii
      Title: title,
...
export const evaluateAppliaction = async (req, res) => {890
  try {
...
export const getUserApplication = async (req, res) => {
  try {
    ...
    const achvDetails = 
      ...
      // const ApplicantsDetailss =
      // await ApplicationDAO.getApplicantsDetailsByApplication(req);
